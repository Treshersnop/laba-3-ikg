...
#include "pipeline_20.h"
#include "camera_20.h"
#include "texture_20.h"
#include "lighting_technique_20.h"
#include "glut_backend_20.h"
#include "util_20.h"
...
public:
    ...
    bool Init()
    {
        ...
        const char* text = "D:\\kotk.png";
        m_pTexture = new Texture(GL_TEXTURE_2D, text);
...
int main(int argc, char** argv)
{
    ...
    if (!GLUTBackendCreateWindow(WINDOW_WIDTH, WINDOW_HEIGHT, 32, false, "Karimova Tutorial 20")) {
        return 1;
    }
